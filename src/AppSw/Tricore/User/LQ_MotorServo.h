...
#define Servo_Delta 450

#define Servo_Delta 450            //舵机左右转动的差值，与舵机型号，拉杆和舵机臂长有关
#define Servo_Center_Mid 1540     //舵机直行中值，
...
extern volatile uint16 BatVolt;         // 电池电压采集
...
extern volatile unsigned char Camera_Flag; // 场标识
